        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="dist/img/usero.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                ...
                <div class="container-fluid">
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                <div class="col">
                                    <a href="" class="btn btn-custom" style="background-color: skyblue;">Import Excel</a>
                                </div>
                                <div class="col">
                                    <a href="{{ route('export_user_pdf') }}"  class="btn btn-custom" style="background-color: skyblue;">Import PDF</a>
                                </div>
                                        ...
                                        <div class="row w-75 mx-auto">
                                            ...
                                            <div class="col-sm d-flex align-items-center">
                                                <a href="{{ route('updateUser') }}"
                                                    class="btn btn-sm btn-success btn-block mb-2" style="background-color: rgb(107, 123, 129);"><i
                                                        class="fas fa-edit"></i> Update</a>
                                            </div>
                                            <div class="col-sm d-flex align-items-center">
                                                <button class="btn btn-sm btn-danger btn-block mb-2" style="background-color: rgb(4, 66, 90)"
